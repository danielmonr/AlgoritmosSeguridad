...
public class TripleDES extends ActionBarActivity {
    ...
    TextView tv;
    int contadorPaginas;
    int[] Paginas = {R.string.TripDES_explicacion_1, R.string.TripDES_explicacion_2, R.string.TripDES_explicacion_3, R.string.TripDES_explicacion_4, R.string.TripDES_explicacion_5, R.string.TripDES_explicacion_6};
